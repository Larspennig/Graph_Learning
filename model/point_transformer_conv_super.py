...
from model.message_passing_custom import MessagePassing
...
class PointTransformerConv_Super(MessagePassing):
    ...
    def __init__(self, in_channels: Union[int, Tuple[int, int]],
        ...
        # add parameter of how much should i use new values
    ...
    def forward(
        ...
        out = self.propagate(edge_index, x=x, pos=pos, alpha=alpha,
                             edge_index_soft_idx=edge_index_soft_idx, edge_index_soft_v=edge_index_soft_v)
        return out
